...
SELECT 
concat('ContyC_', CCD.ACTUAL_CALLID) as ActivityKey,
DATE(CCD.CALL_STARTED_LOCAL) as OriginalStartDate,
'2017-12-31' as StartDate,
'2018-01-30' as EndDate,
...
drop view continuity_activity_jan18;

select count(*) from continuity_activity_jan18;
...
SELECT 
concat('ContyCW_', CCD.ACTUAL_CALLID) as ActivityKey,
DATE(CCD.CALL_STARTED_LOCAL) as OriginalStartDate,
DATE(date_add(CCD.CALL_STARTED_LOCAL, INTERVAL + 364 DAY)) as StartDate,
DATE(date_add(CCD.COMPLETED_ON_LOCAL, INTERVAL + 364 DAY)) as EndDate,
'bucket' as ExternalID, 
CCD.CALL_TYPE_CODE as ActivityType,
STORE.LATITUDE as Latitude, STORE.LONGITUDE as Longitude,
'all-day' as 'timeslot',
...
select * from continuity_activity_jan18_wm limit 100;
select count(*) from continuity_activity_jan18_wm;
...
-- Data Upload 
--
select ActivityKey, ReqResource as ResourceId, activitytype, startdate, enddate, Latitude, Longitude, PlannedDuration as Duration, StartTime, EndTime, Store, city as City, state as State, zip as Zip, 'Eastern' as Timezone, TimeSlot as TimeSlot, Resource_No, DOW from continuity_activity_jan18;
select ActivityKey, ReqResource as ResourceId, activitytype, startdate, enddate, Latitude, Longitude, PlannedDuration as Duration, StartTime, EndTime, Store, city as City, state as State, zip as Zip, 'Eastern' as Timezone, TimeSlot as TimeSlot, Resource_No, DOW from continuity_activity_jan18_wm;
